#############################################################################
# Makefile for building: INTICOIN-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: lun abr 22 17:28:14 2019
# Project:  INTICOIN-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile INTICOIN-qt.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -IC:\INTICOIN\db-4.8.30.NC\build_unix -Ibuild -Ibuild
LINK          = g++
...
SOURCES       = src/txdb-leveldb.cpp \
		...
		src/INTICOINX/IntiTest.cpp build/moc_bitcoingui.cpp \
...
$(TARGET): /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/src/leveldb/libleveldb.a /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: INTICOIN-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile INTICOIN-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/INTICOIN-qt1.1.5 || $(MKDIR) build/INTICOIN-qt1.1.5 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/INTICOIN-qt1.1.5/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/INTICOIN-qt1.1.5/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/coincontrol.h src/sync.h src/util.h src/uint256.h src/kernel.h src/scrypt.h src/pbkdf2.h src/INTICOINX/Accumulator.h src/INTICOINX/AccumulatorProofOfKnowledge.h src/INTICOINX/Coin.h src/INTICOINX/CoinSpend.h src/INTICOINX/Commitment.h src/INTICOINX/ParamGeneration.h src/INTICOINX/Params.h src/INTICOINX/SerialNumberSignatureOfKnowledge.h src/INTICOINX/SpendMetaData.h src/INTICOINX/IntiTest.h src/INTICOINX/INTICOINX.h src/serialize.h src/strlcpy.h src/main.h src/miner.h src/net.h src/key.h src/db.h src/txdb.h src/walletdb.h src/script.h src/init.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/threadsafety.h build/INTICOIN-qt1.1.5/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/INTICOIN-qt1.1.5/ && $(COPY_FILE) --parents src/txdb-leveldb.cpp src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/miner.cpp src/init.cpp src/net.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-arm.S src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt.cpp src/pbkdf2.cpp src/INTICOINX/Accumulator.cpp src/INTICOINX/AccumulatorProofOfKnowledge.cpp src/INTICOINX/Coin.cpp src/INTICOINX/CoinSpend.cpp src/INTICOINX/Commitment.cpp src/INTICOINX/ParamGeneration.cpp src/INTICOINX/Params.cpp src/INTICOINX/SerialNumberSignatureOfKnowledge.cpp src/INTICOINX/SpendMetaData.cpp src/INTICOINX/IntiTest.cpp build/INTICOIN-qt1.1.5/ && $(COPY_FILE) --parents src/qt/forms/coincontroldialog.ui src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/INTICOIN-qt1.1.5/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/INTICOIN-qt1.1.5/ && (cd `dirname build/INTICOIN-qt1.1.5` && $(TAR) INTICOIN-qt1.1.5.tar INTICOIN-qt1.1.5 && $(COMPRESS) INTICOIN-qt1.1.5.tar) && $(MOVE) `dirname build/INTICOIN-qt1.1.5`/INTICOIN-qt1.1.5.tar.gz . && $(DEL_FILE) -r build/INTICOIN-qt1.1.5


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/src/leveldb/libleveldb.a; cd /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/src/leveldb/libleveldb.a: FORCE
	cd /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/build/build.h: FORCE
	cd /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN; /bin/sh share/genbuild.sh /home/ubuntu/Documentos/INTICOIN_1.1.5/INTICOIN/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/images/fontmine.png \
		src/qt/res/images/chuspa.png \
		...
		src/qt/res/icons/toolbarinticoin.png \
		src/qt/res/icons/INTICOIN.png \
...
build/Accumulator.o: src/INTICOINX/Accumulator.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Accumulator.o src/INTICOINX/Accumulator.cpp

build/AccumulatorProofOfKnowledge.o: src/INTICOINX/AccumulatorProofOfKnowledge.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/AccumulatorProofOfKnowledge.o src/INTICOINX/AccumulatorProofOfKnowledge.cpp

build/Coin.o: src/INTICOINX/Coin.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Coin.o src/INTICOINX/Coin.cpp

build/CoinSpend.o: src/INTICOINX/CoinSpend.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/CoinSpend.o src/INTICOINX/CoinSpend.cpp

build/Commitment.o: src/INTICOINX/Commitment.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Commitment.o src/INTICOINX/Commitment.cpp

build/ParamGeneration.o: src/INTICOINX/ParamGeneration.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/ParamGeneration.o src/INTICOINX/ParamGeneration.cpp

build/Params.o: src/INTICOINX/Params.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Params.o src/INTICOINX/Params.cpp

build/SerialNumberSignatureOfKnowledge.o: src/INTICOINX/SerialNumberSignatureOfKnowledge.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/SerialNumberSignatureOfKnowledge.o src/INTICOINX/SerialNumberSignatureOfKnowledge.cpp

build/SpendMetaData.o: src/INTICOINX/SpendMetaData.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/SpendMetaData.o src/INTICOINX/SpendMetaData.cpp

build/IntiTest.o: src/INTICOINX/IntiTest.cpp src/INTICOINX/INTICOINX.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/INTICOINX/SpendMetaData.h \
		src/INTICOINX/ParamGeneration.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/IntiTest.o src/INTICOINX/IntiTest.cpp
