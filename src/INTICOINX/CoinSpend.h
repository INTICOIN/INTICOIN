 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the INTICOINX library.
 *
...
/** The complete proof needed to spend a INTICOINX.
...
public:
	...
	/**Generates a proof spending a INTICOINX.
	 *
	 ...
	 * @throw INTICOINXException if the process fails
	 */
