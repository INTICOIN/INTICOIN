 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the INTICOINX library.
 *
...
public:
	 ...
	 * @throw      INTICOINX exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		INTICOINX exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A INTICOINXException if the accumulator value is invalid.
	//  */
